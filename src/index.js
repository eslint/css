...
import noInvalidImportPlacement from "./rules/no-invalid-import-placement.js";
...
const plugin = {
	...
	rules: {
		...
		"no-invalid-import-placement": noInvalidImportPlacement,
	...
	configs: {
		recommended: {
			...
			rules: /** @type {const} */ ({
				...
				"css/no-invalid-import-placement": "error",
